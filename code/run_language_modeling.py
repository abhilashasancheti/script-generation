...
from language_modeling import TextDataset, LineByLineTextDataset
...
def main():
    ...
    if model_args.config_name:
        config = GPT2Config.from_pretrained(model_args.config_name, cache_dir=model_args.cache_dir)
    ...
    if model_args.tokenizer_name:
        tokenizer = GPT2Tokenizer.from_pretrained(model_args.tokenizer_name, cache_dir=model_args.cache_dir)
    elif model_args.model_name_or_path:
